...
<h2 id="ctl00_ContentPlaceHolder1_h2title">Delight Spcial Shirt Pcs</h2>
<div class="fr">
...
<footer>
    <div class="wrapper">
        ...
        <div id="footerr" class="fr">
            ...
            <div class="textopt">
                <a href="http://www.facebook.com/delightdiscount" target="_blank"><i class="fa fa-facebook-square"></i></a>
                <a href="http://twitter.com/Delight E-COMMERCE LTD" target="_blank"><i class="fa fa-twitter-square"></i></a>
                <a href="http://plus.google.com/u/0/delightdiscount/posts" target="_blank"><i class="fa fa-google-plus-square"></i></a>
