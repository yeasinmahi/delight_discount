<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="DelightDiscount.FrontSection.Profile" %>
            ...
            <div class="form-group">
                <div class="">
                    <form id="miniforgot" action="" style="display: none" class="loginPannel form-group">
                        <div class="title text-primary">User Profile</div>
                        <ul class="list-group">
