<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="SPJoypurhat.aspx.cs" Inherits="DelightDiscount.SPJoypurhat" %>
                ...
                <div id="servicePartner" class="servicePartnerSection row text-center">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="serviceBtnDiv">
                            <div class="step1">
                                <img class="img img-responsive img-thumbnail center-block" src="ecommerce/img/cLogo/Bismillah Hotel And Restuarant.jpg"/>
                            </div>
                            
                            <div class="step2">
                                <div class="">
                                    <h3 class="comName">Bismillah Hotel And Restuarant</h3>
                                    <p class="comAdd">
                                        <br/>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="serviceBtnDiv">
                            <div class="step1">
                                <img class="img img-responsive img-thumbnail center-block" src="ecommerce/img/cLogo/the-snacks-bar-located.jpg"/>
                            </div>
                            <div class="step2">
                                <div class="">
                                    <h3 class="comName">The-Snacks-Bar </h3>
                                    <p class="comAdd">
                                       <br/>
                                       Joypurhat, Bangladesh.
                                    </p>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="serviceBtnDiv">
                            <div class="step1">
                                <img class="img img-responsive img-thumbnail center-block" src="ecommerce/img/cLogo/05.png"/>
                            </div>
                            <div class="step2">
                                <div class="">
